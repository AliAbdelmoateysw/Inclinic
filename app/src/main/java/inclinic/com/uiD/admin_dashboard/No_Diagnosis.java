...
public class No_Diagnosis extends AppCompatActivity {

    int dias ;
   // ArrayList<String> Mon = new ArrayList<>();
    private TextView txtNodiagnosis;
    private int  nodiagnosis;
    int Size;
    DatabaseReference fb;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_no__diagnosis);
//=========== Action Bar Change   ================
...
//=========== Get text ID   ================
        txtNodiagnosis = findViewById(R.id.txt_NEW_No_Diagnosis);
//=========== Set Text   ================
        ...
        fb.child("Visitors").orderByChild("type").equalTo("Diagnosis").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                txtNodiagnosis.setText( String.valueOf(Size));
    ...
    private void setupBarChart() {
        ...
        fb.child("Visitors").orderByChild("type").equalTo("Diagnosis").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                BarDataSet dataSet = new BarDataSet(barEntries,"Diagnosis Bar");
