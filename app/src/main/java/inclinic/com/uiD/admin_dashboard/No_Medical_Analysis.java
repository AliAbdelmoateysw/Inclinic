...
public class No_Medical_Analysis extends AppCompatActivity {

    int media ;
    //ArrayList<String> Mon = new ArrayList<>();
    private TextView txt_medical_analysis;
    private int  no_medical_analysis;
    int Size;
    DatabaseReference fb;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_no__medical__analysis);
//=========== Action Bar Change   ================
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("Medical Analysis");
            getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        }
//=========== Get text ID   ================
        txt_medical_analysis = findViewById(R.id.txt_NEW_No_MedicalAnalysis);
//=========== Set Text   ================
        ...
        fb.child("Visitors").orderByChild("type").equalTo("Medical Test").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                txt_medical_analysis.setText( String.valueOf(Size));
            }
            @Override
